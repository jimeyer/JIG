...
This scope defines the remaining work to bring both JIG and DIG CLIs into full conformance with [[jig/dig/archive/DJ002_SCOPE_CLI_Recommendations]]. Phase 0-1 (output flags, command restructuring) is complete for JIG. This scope covers:
